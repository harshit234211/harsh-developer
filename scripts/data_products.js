...
const DEVCRAFT_PRODUCTS = [
  // ==========================================
  // 1. FEATURED FLAGSHIP AI PRODUCTS (FULL SOURCE CODE)
  // ==========================================
  {
    id: 'joya-ai',
    name: 'Joya AI — Full Source Code',
    type: 'app',
    category: 'Android Apps',
    platform: 'Android (Kotlin / Studio)',
    badge: '50% OFF • Full Source Code Included',
    originalPrice: 1999,
    shortDesc: 'Complete Android Studio source code for Joya AI autonomous voice assistant with wake word "Wake up Joya", offline speech recognition, and WhatsApp automation.',
  ...
  {
    id: 'jarvis-ai',
    name: 'Jarvis AI — Full Source Code',
    type: 'app',
    category: 'PC Software',
    platform: 'Windows / PC (Electron / Python)',
    badge: '50% OFF • Full Source Code Included',
    originalPrice: 3199,
    shortDesc: 'Complete PC desktop project source code for Jarvis AI autonomous desktop intelligence agent with voice listening, terminal automation, and local LLM bridge.',
